...
DEFAULT_FILTER_FIELDS = ["org", "modes", "language", "classfy", "middle_classfy", "linguistics", "range", 'course_period']
...
def course_discovery_search(search_term=None, size=20, from_=0, field_dictionary=None):
    ...
    use_search_fields = ["org", "language", "modes", 'classfy', 'middle_classfy', 'linguistics', 'range', 'course_period']
